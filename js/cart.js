         ...
         <div class="col-sm-6 col-md-6 col-lg-3">
          ...
          <div class="col-sm-6 col-md-6 col-lg-9">
            ...
            <div class="row border-bottom align-items-center">
              <p class="col-sm-6 text-start my-2"> Costo:
              </p>
              <p class="col-sm-6 text-end my-2"> ${producto.currency} ${producto.unitCost}
              </p>
            </div>
            <div class="row border-bottom align-items-center">
             <p class="col-sm-9 col-lg-11 text-start my-2"> Cantidad:</p>
             <label class="col-sm-3 col-lg-1 justify-content-md-end"> 
            ...
            <div class="row border-bottom align-items-center mb-2">
              <p class="col-sm-6 text-start my-2"> Subtotal:
              </p>
              <p id="${producto.id}|${i}" class="col-sm-6 text-start text-end my-2">${producto.currency} ${producto.unitCost * producto.count} 
              </p>
            </div>
            <div class="row mb-2">
        ...
        <div class="container bg-light rounded">
          ...
          <div class="row">
            <div class="col-md-6 mb-4">
               ...
               <input id="calle" class="w-75 rounded border border-primary bg-dark text-light" type="text" name="calle">
            </div>
            <div class="col-md-6 mb-4">
               <p class="h6 d-block text-muted m-0">Número</p>
               <input id="numero" class="w-75 rounded border border-primary bg-dark text-light" type="text" name="numero">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-4">
              <p class="h6 d-block text-muted m-0">Esquina</p>
              <input id="esquina" class="w-75 rounded border border-primary bg-dark text-light" type="text" name="esquina">
            </div>
          </div>  
        </div>
       `
